...
export const SCENARIOS: Scenario[] = [
  {
    ...
    confidence: 96,
    value: 85000,
    short: 'AO #2025-441 : HUG Genève — Renouvellement 48 onduleurs salle blanche bloc op. B',
    ...
    modalBadge: 'AO #2025-441',
    modalBadgeClass: 'badge-simap',
    modalRef: 'REF: HUG-GE-2025-441 · Source: Simap.ch',
    modalActionLabel: '📤 Envoyer au CRM & Agenda',
    modalContent: `<div class="font-mono text-xs bg-slate-950/80 border border-slate-700/60 rounded-xl p-4 mb-5"><div class="flex flex-col gap-1 text-slate-400"><div><span class="text-slate-600 mr-2">De :</span><span class="text-white">compte.commercial@statron.ch</span></div><div><span class="text-slate-600 mr-2">À :</span><span class="text-white">direction.technique@hug.ch</span></div><div><span class="text-slate-600 mr-2">CC :</span><span class="text-white">achats@hug.ch</span></div><div><span class="text-slate-600 mr-2">Objet :</span><span class="text-amber-300">Réponse AO #2025-441 — Onduleurs Salle Blanche / Statron Série S6300</span></div></div></div><div class="space-y-3 text-slate-300"><p>Monsieur le Directeur Technique,</p><p>Suite à la publication de votre appel d'offres concernant le renouvellement de vos 48 onduleurs pour le bloc opératoire B, <strong class="text-white">Statron Romandie</strong> est en mesure de vous proposer une solution complète et éprouvée.</p><div class="bg-slate-800/60 rounded-xl p-4 border border-slate-700/40"><p class="text-xs font-bold text-cyan-400 uppercase tracking-wider mb-3 font-mono">Points Différenciants — Série S6300 Medical</p><ul class="space-y-2 text-sm"><li class="flex gap-2"><span class="text-emerald-400 mt-0.5">✔</span><span><strong class="text-white">Proximité opérationnelle</strong> — Techniciens certifiés basés à Genève, temps de réponse SLA garanti &lt;2h</span></li><li class="flex gap-2"><span class="text-emerald-400 mt-0.5">✔</span><span><strong class="text-white">Fiabilité prouvée</strong> — MTBF &gt;260'000h, installation de référence identique au CHUV (2022)</span></li><li class="flex gap-2"><span class="text-emerald-400 mt-0.5">✔</span><span><strong class="text-white">Conformité médicale</strong> — Norme CEI 60364-7-710, IEC 62040</span></li><li class="flex gap-2"><span class="text-emerald-400 mt-0.5">✔</span><span><strong class="text-white">Contrat SLA inclus</strong> — Maintenance préventive annuelle + remplacement batteries sans coût additionnel année 1</span></li></ul></div><p>Je vous propose un <strong class="text-amber-400">audit gratuit de l'installation existante</strong> avant la clôture de l'appel d'offres.</p><p class="mt-4">Cordialement,<br/><strong class="text-white">Marc Dupont</strong> — Account Manager Romandie<br/><span class="text-slate-500 text-xs font-mono">+41 22 700 XX XX · m.dupont@statron.ch</span></p></div>`,
  },
  {
    id: 2,
    type: 'competitor',
    ...
    modalRef: 'REF: COMP-NE-2025-089 · Source: Google Reviews Crawler',
    modalActionLabel: '📞 Créer Opportunité CRM',
    modalContent: `<div class="grid grid-cols-3 gap-3 mb-5"><div class="bg-rose-900/20 border border-rose-500/30 rounded-xl p-3 text-center"><div class="text-2xl font-syne font-bold text-rose-400">1.8⭐</div><div class="text-xs text-slate-400 font-mono mt-1">NOTE GOOGLE</div></div><div class="bg-slate-800/60 border border-slate-700/30 rounded-xl p-3 text-center"><div class="text-2xl font-syne font-bold text-amber-400">6j</div><div class="text-xs text-slate-400 font-mono mt-1">PANNE EN COURS</div></div><div class="bg-emerald-900/20 border border-emerald-500/30 rounded-xl p-3 text-center"><div class="text-2xl font-syne font-bold text-emerald-400">72h</div><div class="text-xs text-slate-400 font-mono mt-1">NOTRE DÉLAI</div></div></div><div class="space-y-3 text-sm text-slate-300"><div class="bg-slate-800/40 rounded-xl p-4 border border-slate-700/30"><p class="text-xs font-mono font-bold text-slate-300 uppercase tracking-wider mb-2">Offre Spéciale Reprise</p><table class="w-full text-sm"><thead><tr class="text-slate-500 text-xs"><th class="p-1.5 text-left">Prestation</th><th class="p-1.5 text-right">Concurrent</th><th class="p-1.5 text-right text-emerald-400">Statron</th></tr></thead><tbody class="divide-y divide-slate-700/40"><tr><td class="p-1.5">Audit complet installation</td><td class="p-1.5 text-right text-slate-500 line-through">CHF 1'400</td><td class="p-1.5 text-right font-bold text-emerald-400">OFFERT</td></tr><tr><td class="p-1.5">SLA 4h (24/7) — 12 mois</td><td class="p-1.5 text-right">CHF 5'200</td><td class="p-1.5 text-right font-bold">CHF 4'100</td></tr><tr><td class="p-1.5">Remplacement batteries (prév.)</td><td class="p-1.5 text-right">CHF 800</td><td class="p-1.5 text-right font-bold text-emerald-400">INCLUS</td></tr></tbody></table></div></div>`,
  },
  {
    id: 3,
    type: 'opportunity',
  ...
  },
  {
    ...
    confidence: 91,
    value: 95000,
    short: 'AO #2025-512 : CHUV Lausanne — Contrat maintenance préventive 120 UPS, durée 3 ans.',
    ...
    modalBadgeClass: 'badge-simap',
    modalRef: 'REF: CHUV-VD-2025-512 · Fin contrat Eaton: 31.08.2025',
  ...
  },
  {
    ...
    modalRef: 'REF: COMP-FR-2025-041 · Source: LinkedIn Job API + CRM Croisé',
  ...
  },
  {
    ...
    confidence: 88,
    value: 38000,
    short: 'Rappel CRM : Commune de Fribourg — contrat maintenance échu le 30.03.2025. Renouvellement non signé.',
  ...
  },
  {
    ...
    confidence: 85,
    value: 65000,
    short: 'AO #2025-388 : Canton du Jura — Infrastructure électrique critique, bâtiments administratifs.',
    ...
    modalBadge: 'AO #2025-388',
    modalBadgeClass: 'badge-simap',
    modalRef: 'REF: JU-2025-388 · Clôture: 05.05.2025 · Simap.ch',
...
export const TENDERS: Tender[] = [
  { id: 'AO-2025-441', title: 'Renouvellement 48 onduleurs bloc opératoire B', institution: 'HUG — Hôpitaux Universitaires de Genève', canton: 'GE', type: 'Fournitures', budget: 85000, closingDate: '28.04.2025', daysLeft: 14, compatibility: 96, status: 'urgent' },
  { id: 'AO-2025-512', title: 'Contrat maintenance préventive 120 UPS — 3 ans', institution: 'CHUV — Centre Hospitalier Universitaire Vaudois', canton: 'VD', type: 'Maintenance', budget: 95000, closingDate: '05.05.2025', daysLeft: 21, compatibility: 91, status: 'open' },
  { id: 'AO-2025-388', title: 'Infrastructure électrique critique bâtiments administratifs', institution: 'Canton du Jura — Service des Bâtiments', canton: 'JU', type: 'Fournitures', budget: 65000, closingDate: '05.05.2025', daysLeft: 21, compatibility: 85, status: 'open' },
  { id: 'AO-2025-299', title: 'Alimentation de secours datacenter municipal', institution: 'Ville de Lausanne — Direction du Numérique', canton: 'VD', type: 'Fournitures', budget: 180000, closingDate: '12.05.2025', daysLeft: 28, compatibility: 88, status: 'open' },
  { id: 'AO-2025-310', title: 'Maintenance UPS salles serveurs — 5 sites', institution: 'CFF — Infrastructure Romandie', canton: 'VD', type: 'Maintenance', budget: 120000, closingDate: '19.05.2025', daysLeft: 35, compatibility: 79, status: 'open' },
  { id: 'AO-2025-276', title: 'Protection électrique urgences & blocs opératoires', institution: 'HFR — Hôpital Fribourgeois', canton: 'FR', type: 'Fournitures', budget: 95000, closingDate: '26.05.2025', daysLeft: 42, compatibility: 93, status: 'open' },
  { id: 'AO-2025-341', title: 'Systèmes UPS tours de contrôle aéroportuaires', institution: "Aéroport International de Genève", canton: 'GE', type: 'Fournitures', budget: 240000, closingDate: '02.06.2025', daysLeft: 49, compatibility: 71, status: 'open' },
  { id: 'AO-2025-358', title: 'Onduleurs centraux administration cantonale', institution: 'Canton de Vaud — Service Informatique', canton: 'VD', type: 'Fournitures', budget: 75000, closingDate: '09.06.2025', daysLeft: 56, compatibility: 82, status: 'open' },
  { id: 'AO-2025-401', title: 'Maintenance préventive infrastructure critique Valais', institution: 'État du Valais — DNUM', canton: 'VS', type: 'Maintenance', budget: 55000, closingDate: '16.06.2025', daysLeft: 63, compatibility: 77, status: 'open' },
  { id: 'AO-2025-412', title: 'Protection électrique laboratoires de recherche', institution: 'EPFL — Direction des Infrastructures', canton: 'VD', type: 'Fournitures', budget: 320000, closingDate: '23.06.2025', daysLeft: 70, compatibility: 68, status: 'open' },
  { id: 'AO-2025-425', title: 'Onduleurs modulaires centre de calcul HPC', institution: 'Université de Genève — DSIN', canton: 'GE', type: 'Fournitures', budget: 195000, closingDate: '30.06.2025', daysLeft: 77, compatibility: 74, status: 'open' },
  { id: 'AO-2025-440', title: 'Contrat maintenance UPS réseau distribution', institution: 'Groupe E SA — Réseaux Fribourg', canton: 'FR', type: 'Maintenance', budget: 42000, closingDate: '07.07.2025', daysLeft: 84, compatibility: 86, status: 'open' },
  { id: 'AO-2025-455', title: 'Infrastructure électrique nouveau bâtiment cantonal', institution: 'Canton de Neuchâtel — SIEN', canton: 'NE', type: 'Travaux', budget: 150000, closingDate: '14.07.2025', daysLeft: 91, compatibility: 62, status: 'open' },
  { id: 'AO-2025-001', title: 'Alimentation critique Tier III+ Datacenter Alps Cloud', institution: 'Alps Cloud SA — Nouveau Datacenter Sion', canton: 'VS', type: 'Fournitures', budget: 420000, closingDate: '15.09.2025', daysLeft: 154, compatibility: 93, status: 'open' },
];
...
export const COMPETITORS: Competitor[] = [
  { id: 'statron', name: 'Statron Romandie', marketShare: 28, lastActivity: "Scan automatique — aujourd'hui", alert: 'Leader local', alertLevel: 'low', trend: 'up', radar: { prix: 82, reactivite: 95, couverture: 90, technicite: 88, satisfaction: 91 } },
...
export const PIPELINE: PipelineOpportunity[] = [
  { id: 'p1', title: 'HUG — 48 onduleurs bloc op. B', city: 'Genève', canton: 'GE', value: 85000, aiScore: 96, deadline: '28.04.2025', daysLeft: 14, source: 'Simap.ch', sourceClass: 'badge-simap', icon: '🏥', stage: 'detected' },
  { id: 'p2', title: 'Alps Cloud — Datacenter Sion 2.5MW', city: 'Sion', canton: 'VS', value: 420000, aiScore: 93, deadline: '15.09.2025', daysLeft: 154, source: 'Simap.ch', sourceClass: 'badge-simap', icon: '🏗️', stage: 'detected' },
  { id: 'p3', title: 'Canton Jura — 8 bâtiments admin', city: 'Delémont', canton: 'JU', value: 65000, aiScore: 85, deadline: '05.05.2025', daysLeft: 21, source: 'Simap.ch', sourceClass: 'badge-simap', icon: '🏭', stage: 'detected' },
  { id: 'p4', title: 'CHUV — Maintenance 120 UPS 3 ans', city: 'Lausanne', canton: 'VD', value: 95000, aiScore: 91, deadline: '05.05.2025', daysLeft: 21, source: 'Simap.ch', sourceClass: 'badge-simap', icon: '🏛️', stage: 'qualified' },
  { id: 'p5', title: 'Commune Fribourg — Renouvellement contrat', city: 'Fribourg', canton: 'FR', value: 38000, aiScore: 88, deadline: '25.04.2025', daysLeft: 5, source: 'CRM Interne', sourceClass: 'badge-crm', icon: '🏢', stage: 'qualified' },
  { id: 'p6', title: "Ville de Lausanne — Datacenter municipal", city: 'Lausanne', canton: 'VD', value: 180000, aiScore: 88, deadline: '12.05.2025', daysLeft: 28, source: 'Simap.ch', sourceClass: 'badge-simap', icon: '🏙️', stage: 'qualified' },
  { id: 'p7', title: 'HFR — Protection urgences & blocs op.', city: 'Fribourg', canton: 'FR', value: 95000, aiScore: 93, deadline: '26.05.2025', daysLeft: 42, source: 'Simap.ch', sourceClass: 'badge-simap', icon: '🏥', stage: 'offer_sent' },
  { id: 'p8', title: 'CFF Romandie — Maintenance 5 sites', city: 'Lausanne', canton: 'VD', value: 120000, aiScore: 79, deadline: '19.05.2025', daysLeft: 35, source: 'Simap.ch', sourceClass: 'badge-simap', icon: '🚂', stage: 'offer_sent' },
  { id: 'p9', title: 'EPFL — Laboratoires de recherche', city: 'Lausanne', canton: 'VD', value: 320000, aiScore: 68, deadline: '23.06.2025', daysLeft: 70, source: 'Simap.ch', sourceClass: 'badge-simap', icon: '🔬', stage: 'negotiation' },
  { id: 'p10', title: 'Groupe E SA — Réseau distribution FR', city: 'Fribourg', canton: 'FR', value: 42000, aiScore: 86, deadline: '07.07.2025', daysLeft: 84, source: 'Simap.ch', sourceClass: 'badge-simap', icon: '⚡', stage: 'negotiation' },
...
export const TEAM_MEMBERS = [
  { id: 'u1', name: 'Marc Dupont', role: 'Account Manager', email: 'm.dupont@statron.ch', permissions: ['dashboard', 'pipeline', 'tenders', 'competitors'], lastLogin: 'Il y a 2min', avatar: 'MD' },
  { id: 'u2', name: 'Sophie Meier', role: 'Directrice Commerciale', email: 's.meier@statron.ch', permissions: ['dashboard', 'pipeline', 'tenders', 'competitors', 'settings', 'export'], lastLogin: "Aujourd'hui 09:14", avatar: 'SM' },
  { id: 'u3', name: 'Luca Rossi', role: 'Technicien Senior', email: 'l.rossi@statron.ch', permissions: ['dashboard', 'tenders'], lastLogin: 'Il y a 1h', avatar: 'LR' },
];
